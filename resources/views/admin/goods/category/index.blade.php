  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="{{url('admin/cat/create')}}"> 添加商品分类</a> </li>
        <li>
    ...
    <table class="table table-hover text-center" style="width: 80%;display: inline-table;float: right">
      <tr>
        ...
        <tr>
          ...
          <td><div class="button-group"> <a class="button border-main" href="{{url('admin/cat/'.$value['id'].'/edit')}}"><span class="icon-edit"></span> 修改</a> <a class="button border-red" href="javascript:void(0)" onclick="return del_row({{$value['id']}})"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
        @endforeach
      <tr>
