  ...
  <div class="body-content">
    ...
    <div class="form-group">
          ...
          <div class="field" style="padding-top:8px;"> 
          		无<input name="attr"  type="radio" value="0" checked="checked"/>
     ...
     <div class="form-group">
        ...
        <div class="field"> 
          <input type="radio" name="is_publish" value="1" checked="checked"/>是
      ...
      <div class="form-group">
        ...
        <div class="field"> 
          <input type="radio" name="platform" value="1" checked="checked"/>pc
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="click" value="100" data-validate="member:只能为数字"  />
          <div class="tips"></div>
        </div>
      </div>
      <div class="form-group">
